...
export default function HomeStructuredData() {
  const structuredData = {
    ...
    name: "Aksarify",
    description:
      "Platform uji dan tingkatkan kemampuan pemahaman bacaan Bahasa Indonesia",
    sameAs: [
      "https://facebook.com/aksarify",
      "https://twitter.com/aksarify",
      "https://instagram.com/aksarify",
    ],
